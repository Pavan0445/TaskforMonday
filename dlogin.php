...
<div class="row">
    ...
    <div class="col-md-4 mt-5">
        <div class="card p-3 mt-5">
            <div class="text-center"><h3>Doctor Login</h1></div>
            <form action="dlogin1.php" method="POST" onsubmit="return validate()">
                ...
                <div class="mt-1 h6">New Doctor?<a href="doctorReg.php"> Register</a></div>
            </div>
        </div>
    </form>
</div>