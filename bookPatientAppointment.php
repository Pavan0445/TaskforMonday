...
<div class="container">
    <div class="card p-3 mt-5">
        <form action="bookPatientAppointment1.php" method="post" onsubmit="return validate()">
        <input type="hidden"  name="Doctor_id" value="<?php echo $Doctor_id?>">    
        <div class="h4 text-center">Patient Details</div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="submit" value="Add Details" class="btn btn-primary w-100 mt-3">
                    </div>
            </div>
        </form>
    </div>
